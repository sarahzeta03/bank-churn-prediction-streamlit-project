...
def load_model_and_scaler_encoder():
    model = joblib.load(
        r"C:\Users\SARAH ZETA\OneDrive\Documents\deploy project\model\bank_churn_model.pkl"
        )
    std_scaler = joblib.load(
        r"C:\Users\SARAH ZETA\OneDrive\Documents\deploy project\model\standard_scaler.pkl"
    )
    label_encoder = joblib.load(
        r"C:\Users\SARAH ZETA\OneDrive\Documents\deploy project\model\label_encoder.pkl"
    )
